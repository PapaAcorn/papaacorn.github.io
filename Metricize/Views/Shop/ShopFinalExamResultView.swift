//
//  ShopFinalExamResultView.swift
//  Metricize
//

import SwiftUI

struct ShopFinalExamResultView: View {
    let passed: Bool
    let correct: Int
    let total: Int
    let onContinue: () -> Void
    ...
    private var congratulatoryMessage: String {
        "You've shown you can quickly recognize store weights, grocery quantities, bottle sizes, clothing measurements, and product dimensions you learned. Happy shopping."
    }

    private var retryMessage: String {
        "You need 80% to pass — at least 20 of 25 correct. Review the earlier rounds to strengthen your shopping anchors, then try the final exam again when you're ready."
    }
}
