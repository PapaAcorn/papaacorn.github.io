//
//  GymFinalExamResultView.swift
//  Metricize
//

import SwiftUI

struct GymFinalExamResultView: View {
    let passed: Bool
    let correct: Int
    let total: Int
    let onContinue: () -> Void
    ...
    private var congratulatoryMessage: String {
        "You've shown you can quickly recognize body weights, dumbbells, heavy gym weights, barbell plates, and cardio-machine speeds you learned. You're gym ready."
    }

    private var retryMessage: String {
        "You need 80% to pass — at least 20 of 25 correct. Review the earlier rounds to strengthen your fitness anchors, then try the final exam again when you're ready."
    }
}
