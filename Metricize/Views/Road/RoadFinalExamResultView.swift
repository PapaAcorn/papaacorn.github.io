//
//  RoadFinalExamResultView.swift
//  Metricize
//

import SwiftUI

struct RoadFinalExamResultView: View {
    let passed: Bool
    let correct: Int
    let total: Int
    let onContinue: () -> Void
    ...
    private var congratulatoryMessage: String {
        "You've shown you can quickly recognize the road speeds, warning distances, walking distances, driving distances, and travel-time anchors you learned. Safe travels."
    }

    private var retryMessage: String {
        "You need 80% to pass — at least 20 of 25 correct. Review the earlier rounds to strengthen your travel anchors, then try the final exam again when you're ready."
    }
}
