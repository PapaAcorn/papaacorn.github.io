//
//  KitchenFinalExamResultView.swift
//  Metricize
//

import SwiftUI

struct KitchenFinalExamResultView: View {
    let passed: Bool
    let correct: Int
    let total: Int
    let onContinue: () -> Void
    ...
    private var congratulatoryMessage: String {
        "You've shown you know the kitchen measurement, oven, and food-safety anchors you learned — including the exact USDA temperatures. Well done."
    }
